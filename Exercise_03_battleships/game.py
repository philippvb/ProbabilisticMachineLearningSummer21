...
class Game:
    ...
    def __init__(self, size, ships, nb_samples = 1000,
        ...
        if player1 == "human":
            ...
            self.player1 = MCAgent(ships = ships.copy(),
                                           size = size,
    ...
    def one_turn(self):
        if isinstance(self.player1, HumanAgent) or isinstance(self.player2, HumanAgent):
            print("Please enter the coordinates of your next observation:")
        while True:
            try:
